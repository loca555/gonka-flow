...
(async()=>{
 ...
 try{
  ...
  assert.deepEqual([...mints.workers].sort(),["gonka_bridge_links","gonka_targeted_balances","gonka_targeted_incoming","wgnk_market_flow","wgnk_mints_history","wgnk_mints_live"]);
