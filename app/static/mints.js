...
function details(tx,index){
 ...
 el("mint-detail").innerHTML='<div class="detail-amount">'+esc(amount(e.amount))+' <small>WGNK</small></div><p class="detail-notice">'+
  (burn?"Сжигание WGNK. Не является продажей. Завершение обратного перевода в GNK не проверено.":"Чеканка WGNK. Не является покупкой. Сторона GNK не проверялась.")+
