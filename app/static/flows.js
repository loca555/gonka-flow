...
(()=>{
 ...
 function mount(){
  ...
  '<div class="table-container"><table id="trades-table"><thead><tr><th data-sort="time">Дата и время</th><th data-sort="kind" data-default="asc">Сделка</th><th data-sort="actor" data-default="asc">Адрес / инициатор</th><th class="numeric" title="PNL адреса: продажи − покупки, USDT, за всю историю. Только для адресов с обеими сторонами; результат в пределах ±100 USDT скрыт">PNL · USDT</th><th data-sort="amount" class="numeric">Объём WGNK</th><th data-sort="quote" class="numeric">Сумма USDT</th><th data-sort="price" class="numeric">Цена за 1 WGNK, USDT</th><th data-sort="pool" data-default="asc">Пул</th><th data-sort="tx" data-default="asc">Транзакция</th></tr></thead><tbody id="sales-rows"></tbody></table></div>'+
 ...
 function tradePnlCell(e,data){
  ...
  return '<td class="numeric" title="PNL адреса: продажи − покупки, USDT"><span class="'+(neg?'pnl-neg':'pnl-pos')+'">'+(neg?'−':'+')+' '+esc(value)+'</span></td>';
 }
