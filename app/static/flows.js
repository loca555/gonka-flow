...
(()=>{
 ...
 function tradePnlCell(e,data){
  ...
  return '<td class="numeric" title="PNL по закрытым сделкам: проданное × (цена продажи − средняя цена покупки), USDT. Открытый остаток не учитывается; скрыто при результате в пределах ±100 USDT"><span class="'+(neg?'pnl-neg':'pnl-pos')+'">'+(neg?'−':'+')+' '+esc(value)+'</span></td>';
 }
