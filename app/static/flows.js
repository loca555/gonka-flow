...
(()=>{
 ...
 function tradePnlCell(e,data){
  ...
  return '<td class="numeric" title="PNL адреса по закрытым позициям, метод FIFO: продажи закрывают самые старые покупки. Открытый остаток не учитывается; скрыто при результате в пределах ±100 USDT"><span class="'+(neg?'pnl-neg':'pnl-pos')+'">'+(neg?'−':'+')+' '+esc(value)+'</span></td>';
 }
